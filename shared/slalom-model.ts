  ...
  latestAdditions: [
    {
      shortLabel: '力量与相对力量',
      status: '已接入',
      usage: '卧推、卧拉及其体重倍数按性别冠军区间对比',
    },
    {
      shortLabel: '上肢功率与耐力',
      status: '已接入',
      usage: '峰值功率、Wingate和2分钟次数独立比较',
    },
    {
      shortLabel: '激流专项能力',
      status: '已接入',
      usage: '阈功率、阈心率、300米成绩与握力按性别比较',
    },
  ],
} as const;
...
const relative = (key: 'benchPressKg' | 'benchPullKg') => (values: StrengthMetricValues) => {
  ...
  return typeof value === 'number' && typeof weight === 'number' && weight > 0
    ? value / weight
    : null;
};
...
export const SLALOM_CHAMPION_METRICS: SlalomMetric[] = [
  {
    ...
    group: '基础力量',
    direction: 'higher',
    sourceKey: 'benchPressKg',
    male: [110, 130],
    female: [75, 92],
  },
  {
    key: 'benchPressRelative',
    label: '卧推相对力量',
    unit: '倍体重',
    group: '基础力量',
    direction: 'higher',
    derive: relative('benchPressKg'),
    male: [1.55, 1.85],
    female: [1.4, 1.7],
  },
  {
    ...
    group: '基础力量',
    direction: 'higher',
    sourceKey: 'benchPullKg',
    male: [105, 125],
    female: [72, 88],
  },
  {
    key: 'benchPullRelative',
    label: '卧拉相对力量',
    unit: '倍体重',
    group: '基础力量',
    direction: 'higher',
    derive: relative('benchPullKg'),
    male: [1.5, 1.8],
    female: [1.35, 1.65],
  },
  {
    key: 'benchPressPeakPowerW',
    label: '卧推峰值功率',
    unit: 'W',
    group: '上肢功率',
    direction: 'higher',
    sourceKey: 'benchPressPeakPowerW',
    male: [419, 641],
    female: [380, 470],
  },
  {
    key: 'benchPressRelativePowerWkg',
    label: '卧推相对功率',
    unit: 'W/kg',
    group: '上肢功率',
    direction: 'higher',
    sourceKey: 'benchPressRelativePowerWkg',
    male: [5.7, 8.5],
    female: [6, 7.2],
  },
  {
    key: 'benchPullPeakPowerW',
    label: '卧拉峰值功率',
    unit: 'W',
    group: '上肢功率',
    direction: 'higher',
    sourceKey: 'benchPullPeakPowerW',
    male: [501, 667],
    female: [410, 510],
  },
  {
    key: 'benchPullRelativePowerWkg',
    label: '卧拉相对功率',
    unit: 'W/kg',
    group: '上肢功率',
    direction: 'higher',
    sourceKey: 'benchPullRelativePowerWkg',
    male: [7.1, 8.7],
    female: [6.5, 7.8],
  },
  {
    key: 'wingatePeakPowerWkg',
    label: 'Wingate峰值功率',
    unit: 'W/kg',
    group: 'Wingate',
    direction: 'higher',
    sourceKey: 'wingatePeakPowerWkg',
    male: [8.8, 10.2],
  },
  {
    key: 'wingateWorkJkg',
    label: 'Wingate 30秒总做功',
    unit: 'J/kg',
    group: 'Wingate',
    direction: 'higher',
    sourceKey: 'wingateWorkJkg',
    male: [210, 250],
  },
  {
    key: 'wingateLactateMmol',
    label: 'Wingate乳酸峰值',
    unit: 'mmol/L',
    group: 'Wingate',
    direction: 'higher',
    sourceKey: 'wingateLactateMmol',
    male: [11.2, 14.6],
  },
  {
    key: 'benchPress2MinReps',
    label: '卧推2分钟',
    unit: '次',
    group: '肌耐力',
    direction: 'higher',
    sourceKey: 'benchPress2MinReps',
    male: [66, 78],
    female: [57, 69],
  },
  {
    key: 'benchPull2MinReps',
    label: '卧拉2分钟',
    unit: '次',
    group: '肌耐力',
    direction: 'higher',
    sourceKey: 'benchPull2MinReps',
    male: [74, 89],
    female: [64, 77],
  },
  {
    key: 'thresholdErgPowerW',
    label: '乳酸阈测功仪功率',
    unit: 'W',
    group: '专项能力',
    direction: 'higher',
    sourceKey: 'thresholdErgPowerW',
    male: [170, 190],
    female: [140, 160],
  },
  {
    ...
    group: '专项能力',
    direction: 'higher',
    sourceKey: 'anaerobicThresholdHr',
    male: [155, 175],
    female: [150, 170],
  },
  {
...
export function slalomComparison(
  metric: SlalomMetric,
  values: StrengthMetricValues,
  gender: string
) {
  ...
  const percent =
    metric.direction === 'higher' ? (value / threshold) * 100 : (threshold / value) * 100;
  return {
    value,
    range,
