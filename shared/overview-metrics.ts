...
export const OVERVIEW_METRICS: OverviewMetricDefinition[] = [
  ...
  { code: 'blood_lactate_mmol', label: '血乳酸', domain: 'physiology', unit: 'mmol/L', direction: 'lower_better', frequency: 'daily', projects: common, minimum: 0, maximum: 20 },
  { code: 'creatine_kinase_u_l', label: '肌酸激酶', domain: 'biochemistry', unit: 'U/L', direction: 'lower_better', frequency: 'daily', projects: common, minimum: 0, maximum: 3000 },
  { code: 'blood_urea_n_mmol_l', label: '血尿素', domain: 'biochemistry', unit: 'mmol/L', direction: 'lower_better', frequency: 'daily', projects: common, minimum: 0, maximum: 30 },
  { code: 'hemoglobin_g_l', label: '血红蛋白', domain: 'biochemistry', unit: 'g/L', direction: 'higher_better', frequency: 'daily', projects: common, minimum: 60, maximum: 220 },
  { code: 'hrv_rmssd_ms', label: '心率变异性', domain: 'physiology', unit: 'ms', direction: 'higher_better', frequency: 'daily', projects: common, minimum: 0, maximum: 200 },
  { code: 'resting_heart_rate_bpm', label: '静息心率', domain: 'physiology', unit: 'bpm', direction: 'lower_better', frequency: 'daily', projects: common, minimum: 30, maximum: 180 },
