...
export function AthleteManagementPage({
  ...
  const load = async () => {
    setLoading(true);
    try {
      const [athleteResult, teamResult, assignmentResult] = await Promise.all([
        api.athletes(),
        api.adminTeams(),
        api.assignments(),
      ]);
  ...
  return (
    <div className="page-content athlete-management-page">
      ...
      <section className="athlete-directory-toolbar">
        ...
        <button
          className="athlete-refresh-button"
          onClick={() => void load()}
          disabled={loading}
          aria-label="刷新运动员名册"
        >
        ...
        {(search ||
          ...
          <button className="athlete-reset-button" onClick={resetFilters}>
            重置
          </button>
        )}
      </section>
        ...
        <div className="athlete-table-wrap">
                ...
                <tr key={athlete.id}>
                  {canAdmin && (
                    <td>
                      ...
                      >
                        {selectedIds.has(athlete.id) && <Check size={13} />}
                      </button>
                    </td>
                  )}
                  <td>
                  ...
                  <td>
                    <div className="athlete-row-actions">
                      <button onClick={() => onOpenProfile(athlete)}>
                        <Eye size={14} />
                        档案
                      </button>
                      <button
                      ...
                      {canEdit && (
                        <button onClick={() => openEdit(athlete)}>
                          <PencilLine size={14} />
                          编辑
                        </button>
                      )}
          ...
          {!loading && !paged.length && (
            <div className="athlete-table-state empty">
              <Search size={28} />
              <strong>没有符合条件的运动员</strong>
              <p>调整筛选条件后再试。</p>
              <button onClick={resetFilters}>查看全部运动员</button>
            </div>
          )}
        </div>
        <footer>
      ...
      {advancedOpen && (
        ...
        >
          <section
            ...
            role="dialog"
            aria-modal="true"
            aria-labelledby="athlete-filter-title"
          >
            <header>
              <div>
                <span>ADVANCED FILTER</span>
                <h2 id="athlete-filter-title">高级筛选</h2>
                <p>进一步按训练属性和建档时间缩小范围。</p>
              </div>
              <button
            ...
            <div className="athlete-filter-grid">
              ...
              <label>
                <span>技术等级</span>
                <select
                  value={advanced.technicalLevel}
                  onChange={(event) =>
                    setAdvanced({
                      ...advanced,
                      technicalLevel: event.target.value,
                    })
                  }
                >
        ...
        >
          ...
          >
            ...
            <form onSubmit={(event) => void saveAthlete(event)}>
              <div className="athlete-editor-scroll">
                <aside className="athlete-photo-field">
                  <div>
                    {photoPreview ? (
                      <img src={photoPreview} alt="运动员照片预览" />
                    ) : (
                      <UserRound size={34} />
                    )}
                  </div>
                ...
                <div className="athlete-editor-sections">
                  <section>
                    <h3>
                      <b>01</b>基础身份
                    </h3>
                      ...
                      <label>
                        ...
                        <input
                          ...
                          onChange={(event) =>
                            setForm({
                              ...form,
                              identityNumber: event.target.value.toUpperCase(),
                            })
                          }
                          maxLength={18}
                        />
                  ...
                  <section>
                    ...
                    <div className="athlete-form-grid">
                      ...
                      <label>
                        ...
                        <input
                          ...
                          onChange={(event) =>
                            setForm({
                              ...form,
                              athletePosition: event.target.value,
                            })
                          }
                          maxLength={40}
                          placeholder="例如：舵手、1号位、左桨"
                        />
                      </label>
                      <label>
                        <span>技术等级</span>
                      ...
                      <label>
                        ...
                        <input
                          type="date"
                          value={form.startSportDate}
                          onChange={(event) =>
                            setForm({
                              ...form,
                              startSportDate: event.target.value,
                            })
                          }
                        />
                      </label>
                      <label>
                        ...
                        <input
                          ...
                          onChange={(event) =>
                            setForm({
                              ...form,
                              trainingVenue: event.target.value,
                            })
                          }
                        />
                      </label>
                      ...
                      <label>
                        ...
                        <input
                          ...
                          onChange={(event) =>
                            setForm({
                              ...form,
                              trainingPhase: event.target.value,
                            })
                          }
                        />
                      </label>
                      ...
                      <label>
                        <span>输送教练</span>
                        <input
                          value={form.originCoach}
                          onChange={(event) =>
                            setForm({
                              ...form,
                              originCoach: event.target.value,
                            })
                          }
                        />
                      </label>
      ...
      {bulkOpen && (
        ...
        >
          <section
            ...
            role="dialog"
            aria-modal="true"
            aria-labelledby="athlete-bulk-title"
          >
            <header>
              <div>
            ...
            <div className="athlete-filter-grid">
              ...
              <label>
                <span>位置/号位</span>
                <input
                  value={bulkForm.athletePosition}
                  onChange={(event) =>
                    setBulkForm({
                      ...bulkForm,
                      athletePosition: event.target.value,
      ...
      {injuryAthlete && (
        ...
        >
          <section
            ...
            role="dialog"
            aria-modal="true"
            aria-labelledby="athlete-injury-title"
          >
            <header>
              <div>
            ...
            <form onSubmit={saveInjury}>
              <div className="athlete-injury-grid">
                <label>
                  <span>问题名称或诊断*</span>
                  <input
                    value={injuryForm.injuryName}
                    onChange={(event) =>
                      setInjuryForm({
                        ...injuryForm,
                ...
                <label>
                  ...
                  <select
                    ...
                    onChange={(event) =>
                      setInjuryForm({
                        ...injuryForm,
                        status: event.target.value as InjuryStatus,
                      })
                    }
                  >
                    <option value="observation">观察</option>
                    <option value="restricted">训练受限</option>
                    <option value="rehab">康复中</option>
                    <option value="suspended">暂停训练</option>
                    <option value="healthy">已恢复</option>
                  </select>
                </label>
                <label>
                  <span>疼痛评分 0–10</span>
