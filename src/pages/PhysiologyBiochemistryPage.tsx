      ...
      <section className="training-dashboard-grid" aria-label="生理生化数据展示区域">
        ...
        >
          <ContentState
            ...
            title="暂无生理生化数据"
            description="接入经确认的生理、生化数据模型后，将在此展示当前项目、组织范围和时间范围的整体概览。"
          />
        </ChartCard>
        <ChartCard
          title="核心数据展示"
          description="待根据真实数据字段配置展示内容"
        ...
        >
          <ContentState
            ...
            title="核心指标待配置"
            description="当前未预设指标、单位、正常范围或评价规则。"
          />
        </ChartCard>
        <ChartCard
          title="趋势与分析"
          description="待具备连续、可追溯的真实记录后启用"
        ...
        >
          <ContentState
            ...
            title="暂无趋势数据"
            description="数据模型和采集频率确认后，将按实际业务需求配置趋势与分析方式。"
          />
        </ChartCard>
        <ChartCard
          title="重点信息与记录"
          description="用于承载后续的重点记录和下钻入口"
          className="dashboard-span-12"
        >
          <ContentState
            kind="empty"
            ...
            title="暂无重点记录"
            description="后续可在保留整体展示的基础上，提供运动员个人数据下钻。"
          />
        </ChartCard>
      </section>
    </PageContainer>
