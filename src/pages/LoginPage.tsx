...
const OLYMPIC_DISCIPLINES = [
  ...
  { label: '激流回旋', english: 'Canoe Slalom', gif:'/assets/olympic-sports/canoe slalom.gif', col: 3, row: 1 },
  { label: '静水皮划艇', english: 'Canoe Sprint', gif:'/assets/olympic-sports/canoe sprint.gif', col: 4, row: 1 },
  { label: '自由式小轮车', english: 'Cycling BMX Freestyle', gif:'/assets/olympic-sports/cycling BMX freestyle.gif', col: 5, row: 1 },
  { label: '竞速小轮车', english: 'Cycling BMX Racing', gif:'/assets/olympic-sports/cycling BMX racing.gif', col: 6, row: 1 },
  { label: '山地自行车', english: 'Cycling Mountain Bike', gif:'/assets/olympic-sports/cycling mountain bike.gif', col: 0, row: 2 },
  { label: '公路自行车', english: 'Cycling Road', gif:'/assets/olympic-sports/cycling road.gif', col: 1, row: 2 },
  { label: '场地自行车', english: 'Cycling Track', gif:'/assets/olympic-sports/cycling track.gif', col: 2, row: 2 },
  { label: '跳水', english: 'Diving', gif:'/assets/olympic-sports/diving.gif', col: 3, row: 2 },
  { label: '盛装舞步', english: 'Equestrian Dressage', gif:'/assets/olympic-sports/equestrian dressage.gif', col: 4, row: 2 },
  { label: '马术三项', english: 'Equestrian Eventing', gif:'/assets/olympic-sports/equestrian eventing.gif', col: 5, row: 2 },
  { label: '场地障碍', english: 'Equestrian Jumping', gif:'/assets/olympic-sports/equestrian jumping.gif', col: 6, row: 2 },
  ...
  { label: '竞技体操', english: 'Artistic Gymnastics', gif:'/assets/olympic-sports/artistic gymnastics.gif', col: 3, row: 3 },
  { label: '艺术体操', english: 'Rhythmic Gymnastics', gif:'/assets/olympic-sports/rhythmic gymnastics.gif', col: 4, row: 3 },
  ...
  { label: '空手道·型', english: 'Karate Kata', gif:'/assets/olympic-sports/karate kata.gif', col: 1, row: 4 },
  { label: '空手道·组手', english: 'Karate Kumite', gif:'/assets/olympic-sports/karate kumite.gif', col: 2, row: 4 },
  { label: '马拉松游泳', english: 'Marathon Swimming', gif:'/assets/olympic-sports/marathon swimming.gif', col: 3, row: 4 },
  { label: '现代五项', english: 'Modern Pentathlon', gif:'/assets/olympic-sports/modern pentathlon.gif', col: 4, row: 4 },
  ...
  { label: '运动攀岩', english: 'Sport Climbing', gif:'/assets/olympic-sports/sport climbing.gif', col: 3, row: 5 },
  ...
  { label: '乒乓球', english: 'Table Tennis', gif:'/assets/olympic-sports/table tennis.gif', col: 6, row: 5 },
  ...
  { label: '蹦床', english: 'Trampoline Gymnastics', gif:'/assets/olympic-sports/trampoline gymnastics.gif', col: 2, row: 6 },
  ...
  { label: '水球', english: 'Water Polo', gif:'/assets/olympic-sports/water polo.gif', col: 5, row: 6 },
