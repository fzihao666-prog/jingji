...
const OLYMPIC_DISCIPLINES = [
  ...
  {
    label: '花样游泳',
    english: 'Artistic Swimming',
    gif: '/assets/olympic-sports/artistic swimming.gif',
    col: 1,
    row: 0,
  },
  {
    label: '田径',
    english: 'Athletics',
    gif: '/assets/olympic-sports/athletics.gif',
    col: 2,
    row: 0,
  },
  {
    label: '羽毛球',
    english: 'Badminton',
    gif: '/assets/olympic-sports/badminton.gif',
    col: 3,
    row: 0,
  },
  {
    label: '棒球',
    english: 'Baseball',
    gif: '/assets/olympic-sports/baseball.gif',
    col: 4,
    row: 0,
  },
  {
    label: '垒球',
    english: 'Softball',
    gif: '/assets/olympic-sports/softball.gif',
    col: 5,
    row: 0,
  },
  {
    label: '篮球',
    english: 'Basketball',
    gif: '/assets/olympic-sports/basketball.gif',
    col: 6,
    row: 0,
  },
  {
    label: '三人篮球',
    english: 'Basketball 3X3',
    gif: '/assets/olympic-sports/3x3 basketball.gif',
    col: 0,
    row: 1,
  },
  {
    ...
    gif: '/assets/olympic-sports/beach volleyball.gif',
    col: 1,
    row: 1,
  },
  ...
  {
    label: '激流回旋',
    english: 'Canoe Slalom',
    gif: '/assets/olympic-sports/canoe slalom.gif',
    col: 3,
    row: 1,
  },
  {
    label: '静水皮划艇',
    english: 'Canoe Sprint',
    gif: '/assets/olympic-sports/canoe sprint.gif',
    col: 4,
    row: 1,
  },
  {
    label: '自由式小轮车',
    english: 'Cycling BMX Freestyle',
    gif: '/assets/olympic-sports/cycling BMX freestyle.gif',
    col: 5,
    row: 1,
  },
  {
    label: '竞速小轮车',
    english: 'Cycling BMX Racing',
    gif: '/assets/olympic-sports/cycling BMX racing.gif',
    col: 6,
    row: 1,
  },
  {
    label: '山地自行车',
    english: 'Cycling Mountain Bike',
    gif: '/assets/olympic-sports/cycling mountain bike.gif',
    col: 0,
    row: 2,
  },
  {
    ...
    gif: '/assets/olympic-sports/cycling road.gif',
    col: 1,
    row: 2,
  },
  {
    label: '场地自行车',
    english: 'Cycling Track',
    gif: '/assets/olympic-sports/cycling track.gif',
    col: 2,
    row: 2,
  },
  ...
  {
    label: '盛装舞步',
    english: 'Equestrian Dressage',
    gif: '/assets/olympic-sports/equestrian dressage.gif',
    col: 4,
    row: 2,
  },
  {
    label: '马术三项',
    english: 'Equestrian Eventing',
    gif: '/assets/olympic-sports/equestrian eventing.gif',
    col: 5,
    row: 2,
  },
  {
    label: '场地障碍',
    english: 'Equestrian Jumping',
    gif: '/assets/olympic-sports/equestrian jumping.gif',
    col: 6,
    row: 2,
  },
  { label: '击剑', english: 'Fencing', gif: '/assets/olympic-sports/fencing.gif', col: 0, row: 3 },
  {
    label: '足球',
    english: 'Football',
    gif: '/assets/olympic-sports/football.gif',
    col: 1,
    row: 3,
  },
  ...
  {
    label: '竞技体操',
    english: 'Artistic Gymnastics',
    gif: '/assets/olympic-sports/artistic gymnastics.gif',
    col: 3,
    row: 3,
  },
  {
    ...
    gif: '/assets/olympic-sports/rhythmic gymnastics.gif',
    col: 4,
    row: 3,
  },
  {
    label: '手球',
    english: 'Handball',
    gif: '/assets/olympic-sports/handball.gif',
    col: 5,
    row: 3,
  },
  ...
  { label: '柔道', english: 'Judo', gif: '/assets/olympic-sports/judo.gif', col: 0, row: 4 },
  {
    label: '空手道·型',
    english: 'Karate Kata',
    gif: '/assets/olympic-sports/karate kata.gif',
    col: 1,
    row: 4,
  },
  {
    label: '空手道·组手',
    english: 'Karate Kumite',
    gif: '/assets/olympic-sports/karate kumite.gif',
    col: 2,
    row: 4,
  },
  {
    label: '马拉松游泳',
    english: 'Marathon Swimming',
    gif: '/assets/olympic-sports/marathon swimming.gif',
    col: 3,
    row: 4,
  },
  {
    label: '现代五项',
    english: 'Modern Pentathlon',
    gif: '/assets/olympic-sports/modern pentathlon.gif',
    col: 4,
    row: 4,
  },
  { label: '赛艇', english: 'Rowing', gif: '/assets/olympic-sports/rowing.gif', col: 5, row: 4 },
  {
    label: '七人制橄榄球',
    english: 'Rugby',
    gif: '/assets/olympic-sports/rugby.gif',
    col: 6,
    row: 4,
  },
  { label: '帆船', english: 'Sailing', gif: '/assets/olympic-sports/sailing.gif', col: 0, row: 5 },
  {
    label: '射击',
    english: 'Shooting',
    gif: '/assets/olympic-sports/shooting.gif',
    col: 1,
    row: 5,
  },
  {
    ...
    gif: '/assets/olympic-sports/skateboarding.gif',
    col: 2,
    row: 5,
  },
  {
    ...
    gif: '/assets/olympic-sports/sport climbing.gif',
    col: 3,
    row: 5,
  },
  { label: '冲浪', english: 'Surfing', gif: '/assets/olympic-sports/surfing.gif', col: 4, row: 5 },
  {
    label: '游泳',
    english: 'Swimming',
    gif: '/assets/olympic-sports/swimming.gif',
    col: 5,
    row: 5,
  },
  {
    ...
    gif: '/assets/olympic-sports/table tennis.gif',
    col: 6,
    row: 5,
  },
  {
    label: '跆拳道',
    english: 'Taekwondo',
    gif: '/assets/olympic-sports/taekwondo.gif',
    col: 0,
    row: 6,
  },
  ...
  {
    label: '蹦床',
    english: 'Trampoline Gymnastics',
    gif: '/assets/olympic-sports/trampoline gymnastics.gif',
    col: 2,
    row: 6,
  },
  {
    label: '铁人三项',
    english: 'Triathlon',
    gif: '/assets/olympic-sports/triathlon.gif',
    col: 3,
    row: 6,
  },
  {
    label: '排球',
    english: 'Volleyball',
    gif: '/assets/olympic-sports/volleyball.gif',
    col: 4,
    row: 6,
  },
  {
    label: '水球',
    english: 'Water Polo',
    gif: '/assets/olympic-sports/water polo.gif',
    col: 5,
    row: 6,
  },
  {
    ...
    gif: '/assets/olympic-sports/weightlifting.gif',
    col: 6,
    row: 6,
  },
  {
    label: '摔跤',
    english: 'Wrestling',
    gif: '/assets/olympic-sports/wrestling.gif',
    col: 0,
    row: 7,
  },
] as const;
...
export function LoginPage({ onLogin }: { onLogin: (token: string, user: User) => void }) {
  ...
  const [username, setUsername] = useState(
    () => localStorage.getItem('jingji.rememberedUsername') || ''
  );
  const [password, setPassword] = useState('');
  const [showPassword, setShowPassword] = useState(false);
  const [rememberUsername, setRememberUsername] = useState(() =>
    Boolean(localStorage.getItem('jingji.rememberedUsername'))
  );
        ...
        <div className="olympic-pictogram-panel">
          <div className="olympic-sports-grid" role="list" aria-label="奥运运动项目图标总览">
            {OLYMPIC_DISCIPLINES.map((discipline) => (
              ...
              >
                <span className="olympic-sport-icon" aria-hidden="true">
                  <img src={discipline.gif} alt="" />
                </span>
      ...
      <section className="login-panel">
        <div className={`login-box login-box-${mode}`}>
          <div className="login-heading">
            ...
            <span>
              {mode === 'login' ? '请输入账号和密码进入系统' : '提交资料，审核通过后即可登录'}
            </span>
          </div>
          ...
          {mode === 'login' ? (
            <form onSubmit={login}>
              ...
              <label className="login-field">
                <span>密码</span>
                <div className="auth-input password-auth-input">
                  <LockKeyhole size={18} />
                  <input
              ...
              <div className="auth-preferences">
                ...
                <button
                  ...
                  onClick={() => setError('暂未开通在线找回，请联系系统管理员重置密码。')}
                >
                  忘记密码
                </button>
              </div>
              ...
              <div className="login-submit-stack">
                <button className="primary-button login-button" disabled={submitting}>
                  {submitting ? '登录中…' : '登录系统'} <ArrowRight size={18} />
                </button>
                <button
                  type="button"
                  className="secondary-button register-entry"
            ...
            <div className="registration-complete">
              ...
              <h3>申请已提交</h3>
              <p>{success}</p>
              <button className="primary-button" onClick={() => switchMode('login')}>
                <ArrowLeft size={17} />
                返回登录
              </button>
            </div>
            ...
            <form onSubmit={register} className="registration-form">
                ...
                <div className="form-grid profile-grid">
                  ...
                  <label>
                    ...
                    <select
                      ...
                      disabled={!project || !projectTeams.length}
                      required
                    >
                      <option value="">
                        {!project
                  ...
                  <label>
                    <span>籍贯省份</span>
                    <select
                      value={nativePlaceProvince}
                      onChange={(event) => {
                        setNativePlaceProvince(event.target.value);
                        setNativePlaceCity('');
                      }}
                      required
                    >
                  ...
                  <label>
                    ...
                    <select
                      ...
                      onChange={(event) => setNativePlaceCity(event.target.value)}
                      disabled={!nativePlaceProvince}
                      required
                    >
                      <option value="">
                        {nativePlaceProvince ? '请选择城市' : '请先选择省份'}
                      </option>
                      {(PROVINCE_CITIES[nativePlaceProvince] || []).map((cityName) => (
              ...
              <div className="auth-actions register-actions">
                ...
                <button className="primary-button login-button" disabled={submitting}>
                  {submitting ? '提交中…' : '提交申请'} <ArrowRight size={18} />
                </button>
              </div>
            </form>
          )}
