...
dataSheet('测试指标', ['姓名','测试日期','测试类型','指标代码','指标名称','数值','单位','侧别','协议','备注'], '通用测试指标：一项一行。FMS和冠军模型请优先使用下方专用工作表，导入后会自动进入个人档案分析。', { '侧别':['center','left','right','bilateral'] });
